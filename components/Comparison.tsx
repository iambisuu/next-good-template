  ...
  return (
    <div className="min-h-screen bg-black text-white py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-600/20 text-purple-400 px-4 py-2 rounded-full text-sm mb-8">
            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
            Comparison
          </div>
          
          <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-b from-white to-white/50 bg-clip-text text-transparent mb-6">
          IntelliRite vs. Normal way
          </h1>
          
          {/* <h2 className="text-4xl md:text-5xl font-bold text-white/60 mb-8">
            Let's See the Difference
          </h2>
           */}
          <p className="text-white/60 text-lg max-w-2xl mx-auto leading-relaxed">
          IntelliRite is built to elevate your writing—whether it's research papers, journals, or professional reports—with a clean, AI-enhanced platform that prioritizes quality, structure, and originality.          </p>
        </motion.div>
